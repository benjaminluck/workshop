...
colorSwitchInterval = setInterval(function(){
  elemA = document.querySelector('.circle.one');
  elemB = document.querySelector('.circle.two');

  elemAClasses = elemA.classList.value;
  elemBClasses = elemB.classList.value;

  elemAClasses = elemAClasses.split(' ');
  elemBClasses = elemBClasses.split(' ');

  elemA.classList.remove(...elemAClasses);
  elemA.classList.add(...elemBClasses);

  elemB.classList.remove(...elemBClasses); 
  elemB.classList.add(...elemAClasses);
